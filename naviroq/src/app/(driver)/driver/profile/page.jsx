...
const Profile = lazy(() => import("@/components/Driver/ProfileComponents/Profile/Profile"));
...
function DriverProfile() {
        ...
        async function fetchAndProcessData() {
            if (driverProfile) {
                ...
                try {
                    ...
                    router.push('/error/e094'); // Navigate to error page
                }
            } else {
    ...
    return (
            <Suspense fallback={<LazyLoading/>}>
                <Profile driverProfile={decryptedProfile} />
            </Suspense>
    );
}
