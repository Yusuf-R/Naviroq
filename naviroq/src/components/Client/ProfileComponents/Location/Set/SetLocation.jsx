...
function SetLocation({ clientProfile }) {
    ...
    const initialLocation = clientProfile.addresses?.[0]
        ? { lat: clientProfile.addresses[0].latitude, lng: clientProfile.addresses[0].longitude }
        : { lat: 6.5244, lng: 3.3792 };

    const [currentLocation, setCurrentLocation] = useState(initialLocation);
    const [locationCoords, setLocationCoords] = useState(null);
    const [savedLocations, setSavedLocations] = useState(clientProfile.addresses || []);
